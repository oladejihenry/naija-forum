    ...
    <div class="sidebar" data-color="blue">
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="{{ 'all-posts' == request()->path() ? 'active' : ''}} dropdown">
            <a href="/all-posts">
          ...
          <li class="{{ 'new-about' == request()->path() ? 'active' : ''}}">
            <a href="/new-about">
              <i class="now-ui-icons location_map-big"></i>
              <p>About Us</p>
            </a>
          </li>
          <li class="{{ 'new-privacy' == request()->path() ? 'active' : ''}}">
            <a href="/new-privacy">
              <i class="now-ui-icons location_map-big"></i>
              <p>Privacy Policy</p>
            </a>
          </li>
          <li class="{{ 'new-copyright' == request()->path() ? 'active' : ''}}">
            <a href="/new-copyright">
              <i class="now-ui-icons location_map-big"></i>
              <p>Copyright Info</p>
            </a>
          </li>
          <li class="{{ 'new-tos' == request()->path() ? 'active' : ''}}">
            <a href="/new-tos">
              <i class="now-ui-icons location_map-big"></i>
              <p>Tos</p>
            </a>
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="copyright" id="copyright">
            ...
            <a href="https://www.invisionapp.com" target="_blank">NaijaSwift Admin</a>
          </div>
        </div>
      </footer>
    </div>
